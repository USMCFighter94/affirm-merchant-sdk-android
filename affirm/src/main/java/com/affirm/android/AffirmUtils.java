...
public final class AffirmUtils {
    ...
    private static SpannableString getSpannable(
        ...
        if (logoDrawable != null && index != -1) {
            ...
            spannableString.setSpan(imageSpan, index, index + LOGO_PLACEHOLDER.length(), Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
        } else {
    ...
    private static ImageSpan getLogoSpan(float textSize, @NonNull Drawable logoDrawable, int color) {
